...
// 动态生成的基础组件
export const CbtaiTypographyParagraph = ({
...
//  是否是容器
CbtaiTypographyParagraph.isCanvas = false;

const CbtaiTypographyParagraphSettings = () => {
...
// 组件配置和默认属性
CbtaiTypographyParagraph.craft = {
  displayName: "CbtaiTypographyParagraph",
  props: {
    disabled:  false ,
  },
  related: {
    settings: CbtaiTypographyParagraphSettings,
  },
};
