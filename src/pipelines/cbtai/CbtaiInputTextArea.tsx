...
// 动态生成的基础组件
export const CbtaiInputTextArea = ({ 
...
//  是否是容器
CbtaiInputTextArea.isCanvas = false;
      
const CbtaiInputTextAreaSettings = () => {
...
// 组件配置和默认属性
CbtaiInputTextArea.craft = {
  displayName: "CbtaiInputTextArea",
  props: {
    disabled:  false ,
  },
  related: {
    settings: CbtaiInputTextAreaSettings,
  },
};
