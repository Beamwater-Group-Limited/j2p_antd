...
// 动态生成的基础组件
export const XCbtaiAttachments = ({
...
//  是否是容器
XCbtaiAttachments.isCanvas = false;

const XCbtaiAttachmentsSettings = () => {
...
// 组件配置和默认属性
XCbtaiAttachments.craft = {
  displayName: "XCbtaiAttachments",
  props: {
    disabled:  false ,
  },
    rules: {
  ...
  related: {
    settings: XCbtaiAttachmentsSettings,
  },
};
