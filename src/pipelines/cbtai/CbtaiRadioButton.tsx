...
//  是否是容器
CbtaiRadioButton.isCanvas = false;

const CbtaiRadioButtonSettings = () => {
...
// 组件配置和默认属性
CbtaiRadioButton.craft = {
  displayName: "CbtaiRadioButton",
  props: {
    disabled:  false ,
  },
  related: {
    settings: CbtaiRadioButtonSettings,
  },
};
