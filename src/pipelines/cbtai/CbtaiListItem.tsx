...
import {   v4   } from "uuid";
import {   Form,    Select,    Switch,    Radio,    Checkbox,    Slider,    Input,    Typography,    InputNumber,    List   } from "antd";
...
//  是否是容器
CbtaiListItem.isCanvas = true;

const CbtaiListItemSettings = () => {
...
// 组件配置和默认属性
CbtaiListItem.craft = {
  displayName: "CbtaiListItem",
  props: {
    disabled:  false ,
  },
  related: {
    settings: CbtaiListItemSettings,
  },
};
