...
//  是否是容器
CbtaiLayoutSider.isCanvas = true;

const CbtaiLayoutSiderSettings = () => {
...
// 组件配置和默认属性
CbtaiLayoutSider.craft = {
  displayName: "CbtaiLayoutSider",
  props: {
    disabled:  false ,
  },
  related: {
    settings: CbtaiLayoutSiderSettings,
  },
};
