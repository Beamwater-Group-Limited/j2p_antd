...
// 动态生成的基础组件
export const CbtaiTypographyTitle = ({
...
//  是否是容器
CbtaiTypographyTitle.isCanvas = false;

const CbtaiTypographyTitleSettings = () => {
        ...
        <div>
            <Form labelCol={{ span:24 }} wrapperCol={{ span:24 }}>
                ...
                <Form.Item label="重要程度">
                    <InputNumber
                        value={ props.level }
                        onChange={(value) => setProp((props) => (props.level = value))}
                    />
                </Form.Item>
            </Form>
        </div>
...
// 组件配置和默认属性
CbtaiTypographyTitle.craft = {
  displayName: "CbtaiTypographyTitle",
  props: {
    disabled:  false ,
  },
  related: {
    settings: CbtaiTypographyTitleSettings,
  },
};
