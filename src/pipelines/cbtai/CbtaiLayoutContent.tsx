...
// 动态生成的基础组件
export const CbtaiLayoutContent = ({
...
//  是否是容器
CbtaiLayoutContent.isCanvas = true;

const CbtaiLayoutContentSettings = () => {
...
// 组件配置和默认属性
CbtaiLayoutContent.craft = {
  displayName: "CbtaiLayoutContent",
  props: {
    disabled:  false ,
  },
  related: {
    settings: CbtaiLayoutContentSettings,
  },
};
