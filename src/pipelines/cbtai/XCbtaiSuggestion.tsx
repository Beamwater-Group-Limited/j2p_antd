...
//  是否是容器
XCbtaiSuggestion.isCanvas = false;

const XCbtaiSuggestionSettings = () => {
...
// 组件配置和默认属性
XCbtaiSuggestion.craft = {
  displayName: "XCbtaiSuggestion",
  props: {
    disabled:  false ,
  },
    rules: {
  ...
  related: {
    settings: XCbtaiSuggestionSettings,
  },
};
