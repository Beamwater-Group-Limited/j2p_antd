...
const { Header } = Layout
// 动态生成的基础组件
export const CbtaiLayoutHeader = ({
...
//  是否是容器
CbtaiLayoutHeader.isCanvas = true;

const CbtaiLayoutHeaderSettings = () => {
...
// 组件配置和默认属性
CbtaiLayoutHeader.craft = {
  displayName: "CbtaiLayoutHeader",
  props: {
    disabled:  false ,
    children:  "确认" ,
  },
  related: {
    settings: CbtaiLayoutHeaderSettings,
  },
};
