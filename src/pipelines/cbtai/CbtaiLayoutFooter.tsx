...
const { Footer } = Layout
// 动态生成的基础组件
export const CbtaiLayoutFooter = ({
...
//  是否是容器
CbtaiLayoutFooter.isCanvas = true;

const CbtaiLayoutFooterSettings = () => {
...
// 组件配置和默认属性
CbtaiLayoutFooter.craft = {
  displayName: "CbtaiLayoutFooter",
  props: {
    disabled:  false ,
    children:  "确认" ,
  },
  related: {
    settings: CbtaiLayoutFooterSettings,
  },
};
