...
// 动态生成的基础组件
export const CbtaiInputPassword = ({
...
//  是否是容器
CbtaiInputPassword.isCanvas = false;

const CbtaiInputPasswordSettings = () => {
    ...
    return (
        <div>
            <Form labelCol={{ span:24 }} wrapperCol={{ span:24 }}>
                ...
                <Form.Item label="是否显示密码显隐按钮">
                    <Switch
                        checked={ props.visibilityToggle }
                        onChange={(checked) => setProp((props ) => (props.visibilityToggle = checked))}
                    />
                </Form.Item>
            </Form>
        </div>
...
// 组件配置和默认属性
CbtaiInputPassword.craft = {
  displayName: "CbtaiInputPassword",
  props: {
    disabled:  false ,
    children:  "确认" ,
  },
  related: {
    settings: CbtaiInputPasswordSettings,
  },
};
