...
import { handleOpenComponent} from "@/tools";
import {useAppConfig} from "@/context";
import {LocalStatesSettingsPanel} from "@/ide/app/LocalStatesSettingsPanel";
...
export const SettingsPanel = () => {
    ...
    return selected ? (
            ...
            <Row gutter={[0, 0]} >
                <Col span={24}>
                    <Row className="mb-4" justify="space-between" align="middle">
                        ...
                        <Col>
                            {/*<Tag color="blue">{selected.haveChildren?"容器组件":"元素组件"}</Tag>*/}
                        </Col>
                    </Row>
                    <Row className="mb-4" justify="space-between" align="middle">
                        <Col>
        ...
        <EventSettingsPanel/>
        <EventHandlerSettingPanel/>
        <StatesSettingsPanel/>
        <LocalStatesSettingsPanel/>
        </>
    ) : null
}
