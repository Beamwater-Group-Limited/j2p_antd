...
import {Row, Col, Typography, Tag, Button, Card, Modal} from 'antd';
import {useEditor} from "@craftjs/core";
import {EventSettingsPanel, EventHandlerSettingPanel, ComponentStatesSettingsPanel} from "@/ide";
import {StatesSettingsPanel} from "@/ide/app/StatesSettingsPanel";
import {BaseWebUrl, getInnerFromChartCompo, getInnerFromCompo, handleOpenComponent} from "@/tools";
...
export const ChartSettings = () => {
    const {actions, selected} = useEditor((state, query) => {
        ...
        if (currentNodeId) {
            ...
            console.log("选择的节点属性", selected.props)
        }
        return {selected};
    });
    return  (
